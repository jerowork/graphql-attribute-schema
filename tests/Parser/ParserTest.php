    ...
    public function it_should_parse_directory(): void
    {
        ...
        self::assertEquals([
            new MutationNode(
                ...
                [
                    new ArgNode(
                        ObjectNodeType::create(MutateFoobarInputType::class),
                        'input',
                        null,
                        'input',
                    ),
                ],
                ObjectNodeType::create(FoobarType::class),
                '__invoke',
                null,
            ),
            new MutationNode(
        ...
        self::assertEquals([
            new QueryNode(
                ...
                [
                    ...
                    new ArgNode(
                        ScalarNodeType::create('bool')->setList(),
                        'values',
                        'List of values',
                        'values',
                    ),
        ...
        self::assertEquals([
            new InputTypeNode(
                ...
                [
                    ...
                    new FieldNode(
                        ObjectNodeType::create(FoobarStatusType::class),
                        'status',
                        null,
                        [],
                        FieldNodeType::Property,
            ...
            new InputTypeNode(
                ...
                [
                    ...
                    new FieldNode(
                        ObjectNodeType::create(Baz::class),
                        'baz',
                        null,
                        [],
                        FieldNodeType::Property,
                    ...
                    new FieldNode(
                        ObjectNodeType::create(DateTimeImmutable::class)->setNullableValue(),
                        'date',
                        null,
                        [],
                        FieldNodeType::Property,
        ...
        self::assertEquals([
            new TypeNode(
                ...
                [
                    ...
                    new FieldNode(
                        ObjectNodeType::create(FoobarStatusType::class)->setNullableValue(),
                        'status',
                        null,
                        [],
                        FieldNodeType::Property,
